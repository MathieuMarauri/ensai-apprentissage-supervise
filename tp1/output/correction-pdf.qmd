...
::: {style="text-align: center; padding: 20px 10px;"}
![Le fléau de la dimension. Plus le nombre de dimensions augmente, plus le nombre de points dans la sphére unité va diminuer. Les points s'éloignent les uns des autres avec l'augmentation du nombre de dimensions.](images/curse-dimensionality.png){width="70%"}
:::
